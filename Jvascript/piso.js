...
t_vpiso.innerHTML = ((parseFloat(lar.value) * parseFloat(com.value)) * 1.2) *
parseFloat(pis.value)
t_varg.innerHTML = (((((parseFloat(lar.value) * parseFloat(com.value)) * 1.2) / 4)) *
parseFloat(arg.value))
t_total.innerHTML = ((parseFloat(lar.value) * parseFloat(com.value)) * 1.2) *
parseFloat(pis.value) + (((((parseFloat(lar.value) * parseFloat(com.value)) * 1.2) / 4)) *
parseFloat(arg.value))
...
function teste(){
if (parseFloat((parseFloat(lar.value) * parseFloat(com.value)) * 1.2) *
parseFloat(pis.value) + (((((parseFloat(lar.value) * parseFloat(com.value)) * 1.2) / 4)) *
parseFloat(arg.value))<parseFloat(orc.value)){
areatotal()
}else{
areatotal1()
}
